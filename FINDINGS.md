...
* none of these experiments have replications. Everything is running once, and then data is analyzed. Hopefully when we get more hardware, we'll be able to experiment with statistical significance in mind

# Inferact/Qwen3.8-27B-NVFP4
## Configurations
* **none** - base configuration recommended by the vLLM cookbook
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 3810.56 | 5769.83 | 6802.94 | 7242.64 | 6779.07 | 6847.58 | 6823.81 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 33.91 | 20.80 | 12.47 | 8.99 | 6.60 | 4.34 | 3.32 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 108.89 | 73.32 | 63.93 | 60.31 | 64.88 | 64.37 | 64.76 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 1522.58 | 2983.25 | 4198.40 | 4776.18 | 5162.38 | 5508.25 | 5790.10 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 48.76 | 38.33 | 27.40 | 21.06 | 17.03 | 12.48 | 9.60 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 273.03 | 130.80 | 101.74 | 88.77 | 84.72 | 77.88 | 73.84 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 1298.85 | 2617.16 | 3789.13 | 4375.38 | 4770.99 | 5122.41 | 5444.94 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 50.13 | 40.51 | 29.75 | 23.24 | 18.92 | 13.97 | 10.84 |
...
| **config** | **concurrency 10** | **concurrency 25** | **concurrency 50** | **concurrency 75** | **concurrency 100** | **concurrency 150** | **concurrency 200** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **none** | 342.15 | 150.21 | 112.63 | 96.01 | 90.57 | 82.92 | 78.91 |
...
| workload | energy/token (v4 / none) | e2e out tok/s/user (v4 / none) | total tok/s (v4 / none) |
| --- | --- | --- | --- |
...
workloads (e.g. simple_chat c=50: 108.1 vs 112.6 mJ/token for `none`).
...
| workload | energy/token at c=200 (none / v4) | total tok/s at c=200 (none / v4) |
| --- | --- | --- |
| coding_agent | 64.8 / 73.8 | 6824 / 6390 |
| api_calls | 73.8 / 90.5 | 5790 / 5241 |
| simple_chat | 78.9 / 100.3 | 5445 / 4741 |

Here `none` (and `v3`) are the most energy-efficient and highest-throughput
